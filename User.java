 ...
 *  a list of user names that s/he follows, and the list's size. */
 public class User {
    ...
    public boolean addFollowee(String name) {
        ...
        // If already follows or trying to follow self
        else if (follows(name) || this.name.equals(name)){
            return false;
        }
    ...
    public boolean removeFollowee(String name) {
        ...
        // Clear last entry and update count
    ...
    public int countMutual(User other) {
        ...
        // Check all followees of the other user
        for (int i = 0; i < other.fCount; i++){
            // Compare with this user's followees
